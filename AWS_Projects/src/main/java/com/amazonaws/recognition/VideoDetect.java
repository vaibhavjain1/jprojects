package com.amazonaws.recognition;
...
/*
 Important links
 	...
 	https://docs.aws.amazon.com/code-samples/latest/catalog/java-rekognition-rekognition-video-stored-video.java.html
	https://ap-south-1.console.aws.amazon.com/rekognition/home?ad=c&cp=bn&p=rkn&region=ap-south-1#/video-analysis
...
public class VideoDetect {
    ...
    private static String bucket = "redacco";
    private static String video = "testvideo.mp4"; 
    private static String queueUrl =  "https://sqs.ap-south-1.amazonaws.com/966415716825/lambdaqueue";
    private static String topicArn="arn:aws:sns:ap-south-1:966415716825:AmazonRekognitionMyTopicName";
    private static String roleArn="arn:aws:iam::966415716825:role/RekognitionRole";
    // Change your values
	...
	private static void GetResultsPersons() throws Exception {
		...
		do {
			...
			personTrackingResult = rek.getPersonTracking(
					new GetPersonTrackingRequest().withJobId(startJobId).withNextToken(paginationToken)
							.withSortBy(PersonTrackingSortBy.TIMESTAMP).withMaxResults(maxResults));
	...
	private static void GetResultsCelebrities() throws Exception {
		...
		do {
			...
			celebrityRecognitionResult = rek.getCelebrityRecognition(
					new GetCelebrityRecognitionRequest().withJobId(startJobId).withNextToken(paginationToken)
	...
	private static void GetResultsModerationLabels() throws Exception {
		...
		do {
			...
			moderationLabelDetectionResult = rek.getContentModeration(
					new GetContentModerationRequest().withJobId(startJobId).withNextToken(paginationToken)
