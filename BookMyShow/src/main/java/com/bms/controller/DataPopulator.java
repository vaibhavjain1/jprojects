...
public class DataPopulator {
	...
	public ResponseEntity<String> generate() {
		...
		MovieEntity spidermanMovie = getMovie("Spiderman", MovieLanguage.ENGLISH, Genre.THRILLER, LocalDate.now());
		MovieEntity batmanMovie = getMovie("Batman", MovieLanguage.ENGLISH, Genre.THRILLER, LocalDate.now().minusDays(1));
